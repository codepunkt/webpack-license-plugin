...
This plugin extracts _open source license information_ about all of the packages in your webpack output and helps you identify and fix problems with your open source licensing policy.

This plugin has full unit and end to end test coverage and is tested with **webpack 2, 3, 4 and 5**. It will help you:

- Discover every package used in your webpack output
