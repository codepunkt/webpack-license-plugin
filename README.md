...
| **`unacceptableLicenseTest`** | When this option is set, it is invoked for every package with a single string parameter: `license`. It should return true when the license is unacceptable and encountering it should fail the build. |
